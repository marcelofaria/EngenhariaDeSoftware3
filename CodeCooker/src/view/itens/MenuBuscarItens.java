...
import static view.itens.MenuAdicionarItens.setLookAndFeel;

/**
 *
 * @author Rafael
 */
public class MenuBuscarItens extends javax.swing.JFrame {

    /**
     * Creates new form MenuBuscarItens
     */
    public MenuBuscarItens() {
        setLookAndFeel();
        initComponents();
        CenteredFrame(this);
