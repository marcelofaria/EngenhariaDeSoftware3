...
import static view.itens.MenuBuscarItens.setLookAndFeel;

/**
 *
 * @author Rafael
 */
public class MenuAlterarItens extends javax.swing.JFrame {

    /**
     * Creates new form MenuAlterarItens
     */
    public MenuAlterarItens() {
        setLookAndFeel();
        initComponents();
        CenteredFrame(this);
