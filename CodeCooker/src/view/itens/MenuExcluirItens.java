...
import static view.itens.MenuAlterarItens.setLookAndFeel;

/**
 *
 * @author Rafael
 */
public class MenuExcluirItens extends javax.swing.JFrame {

    /**
     * Creates new form MenuExcluirItens
     */
    public MenuExcluirItens() {
        setLookAndFeel();
        initComponents();
        CenteredFrame(this);
